...
, q=0xE95E4A5F737059DC60DF5991D45029409E60FC09)
    ...
    temp = hashlib.shake_256(
        alice_ss + b'Dragonfly Key Derivation').hexdigest(512)
    ...
    # bob
    temp = hashlib.shake_256(
        bob_ss + b"Dragonfly Key Derivation").hexdigest(512)
    bob_kck = temp[0:256]
    bob_mk = temp[256:512]
    ...
    # alice側
    alice_confirm = confirm(alice_scalar, bob_scalar,
                            alice_element, bob_element, alice_kck, alice)
    # bob側
    bob_confirm = confirm(bob_scalar, alice_scalar,
                          bob_element, alice_element, bob_kck, bob)
